 ...
 * @since 1.01
 * @author Steven Wanderski, modified by Chris Baldelomar <chris@webplantmedia.com>
			...
			if (slider.usingCSS) {
				...
				if (type === 'slide') {
					...
					if (duration !== 0) {
						...
						el.on(
							'transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd', function(e) {
				...
				if (type === 'slide') {
					...
					el.animate(
						animateObj, duration, 'linear', function() {
							setPositionProperty( params.resetValue, 'reset', 0 );
