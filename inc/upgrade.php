 ...
 * Painted Lady
 *
 * WARNING: This file is part of the core Painted Lady Framework. DO NOT edit this file under any circumstances.
 * Please do all modifications in the form of a child theme.
 *
 * @package Painted_Lady
 * @license GPL-2.0+
 */
...
if ( ! class_exists( 'Painted_Lady_Upgrade' ) ) :
	/**
	 * The Painted_Lady WooCommerce Integration class.
	 */
	class Painted_Lady_Upgrade {
		 ...
		 *
		 * Applies `painted_lady_update_remote_post_options` filter.
		 *
		...
		/**
		 * Integrate the Painted Lady update check into the WordPress update checks.
		 *
		 * This function filters the value that is returned when WordPress tries to pull theme update transient data.
		 *
		 * It uses `painted_lady_update_check()` to check to see if we need to do an update, and if so, adds the proper array to the
		...
		/**
		 * Delete Painted Lady update transient after updates or when viewing the themes page.
		 *
...
return new Painted_Lady_Upgrade();
