 ...
 */
function angiemakesdesign_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'angiemakesdesign_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.angiemakesdesign-front-page) .entry-title,
...
.colors-custom .angiemakesdesign-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.angiemakesdesign-front-page .panel-content .recent-posts article,
...
.colors-custom.angiemakesdesign-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'angiemakesdesign_custom_colors_css', $css, $hue, $saturation );
}
