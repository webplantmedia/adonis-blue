...
if ( ! class_exists( 'Painted_Lady_Content_Widget_Slider' ) ) :
	/**
	 ...
	 */
	class Painted_Lady_Content_Widget_Slider extends Painted_Lady_Widget {
		/**
		 * __construct
		 *
		 * @since Painted_Lady 1.01
		...
		public function __construct() {
			$this->widget_id          = 'painted-lady-content-widget-slider';
			$this->widget_description = esc_html__( 'Displays a slider on your widgetized page.', 'painted-lady' );
			$this->widget_name        = esc_html__( 'Painted Lady: Slider', 'painted-lady' );
			$this->settings           = array(
				'panels'   => array(
					array(
				...
				'repeater' => array(
					'title'   => esc_html__( 'Page', 'painted-lady' ),
					'fields'  => array(
						'page'                    => array(
							'type'        => 'page',
							'std'         => '',
							'label'       => esc_html__( 'Select Page:', 'painted-lady' ),
							'description' => esc_html__( 'Create a new page with the the content and featured image you want to display for this slide item. If no featured image is set, then this slide item will display only the background color selected.', 'painted-lady' ),
							'sanitize'    => 'text',
						),
						...
						'button_style'            => array(
							...
							'options'  => array(
								...
								'button-3' => esc_html__( 'White Border Button', 'painted-lady' ),
							),
							'sanitize' => 'text',
						),
					),
...
add_action( 'widgets_init', array( 'Painted_Lady_Content_Widget_Slider', 'register' ) );
