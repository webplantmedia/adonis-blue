					...
					'fields'  => array(
						'page'                    => array(
							...
							'description' => sprintf(
								...
								esc_html__( 'with the the content and featured image you want to display for this slide item. If no featured image is set, then this slide item will display only the background color selected.', 'crimson-rose' )
							),
							'sanitize'    => 'text',
						),
