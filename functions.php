...
function angie_makes_design_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'angie_makes_design_content_width', 640 );
}
...
function angie_makes_design_scripts() {
	...
	wp_enqueue_script( 'angie-makes-design-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'angie-makes-design-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
